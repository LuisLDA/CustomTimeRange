...
var _CustomTimeSelect = require("./components/CustomTimeSelect");
...
function CustomTimeRange(props) {
  ...
  var {
    toggleFilter
  } = (0, _useFilter.useFilter)(props);
  return /*#__PURE__*/_react.default.createElement(_CustomTimeSelect.CustomTimeSelect, {

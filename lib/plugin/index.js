 ...
 * under the License.
 */
class CustomTimeRange extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    var metadata = new _core.ChartMetadata({
      ...
      name: (0, _core.t)('Custom Time Range'),
      thumbnail: _thumbnail.default,
      behaviors: [_core.Behavior.InteractiveChart, _core.Behavior.NativeFilter
    ...
    super({
      ...
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../CustomTimeRange'))),
      metadata,
      transformProps: _transformProps.default
    });
  }
}
exports.default = CustomTimeRange;